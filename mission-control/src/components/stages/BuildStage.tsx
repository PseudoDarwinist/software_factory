...
+  bg-800: #1A1A20;`)
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center">
          <div className="w-8 h-8 border-2 border-yellow-400/20 border-t-yellow-400/80 rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-yellow-300/80">Loading build tasks...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="h-full flex bg-gray-900 text-white">
      ...
      <div className="w-80 bg-gray-800/50 border-r border-white/10 flex flex-col">
            ...
            <div className="p-6 border-b border-white/10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center space-x-4 text-sm text-yellow-300/80">
      ...
      {selectedTask && (
        <div className="w-96 bg-gray-800/50 border-l border-white/10 flex flex-col">
          {/* Diff Preview */}
          <div className="flex-1 p-6">
            <div className="mb-4">
              <h3 className="text-lg font-medium text-yellow-400 mb-2">Diff preview</h3>
              {selectedTask.pr_url && (
                <p className="text-sm text-yellow-300/80 mb-2">ui/theme/tokens.css</p>
              )}
            </div>
  ...
  return (
    <div className="p-4 border-b border-white/5">
      ...
      <div className="space-y-2">
          ...
          >
            <div className="flex items-start justify-between mb-2">
              <div className="flex-1 min-w-0">
                <h4 className="text-sm font-medium text-yellow-300 truncate">
        ...
        {tasks.length === 0 && (
          <div className="text-center py-4 text-yellow-300/60 text-sm">
